import {humanizeCommentDate, humanizeFilmReleaseDate} from "../utils";

const createFilmDetailGenres = (genres) => {
  return (`
...
const createFilmDetailComments = (comments) => {
  return (`
...
export const createFilmDetailsTemplate = (film) => {
  const {name, originalName, writers, producer, ageRating, fullPoster, actors, countries, date, genres, description, comments, duration, rating} = film;
      ...
      <form class="film-details__inner" action="" method="get">
        ...
        <div class="form-details__bottom-container">
          <section class="film-details__comments-wrap">
            ...
            ${createFilmDetailComments(comments)}
